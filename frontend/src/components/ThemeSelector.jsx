  ...
  return (
    <div>
        <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8 p-4 sm:p-6 bg-gradient-to-r from-white to-violet-50 rounded-2xl border border-violet-100'>
            ...
            <button className='w-full sm:w-auto flex items-center justify-center gap-3 px-6 py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-xl transition-all shadow-lg hover:shadow-xl hover:scale-105' onClick={handleThemeSelection}>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8'>
            ...
            <div className='lg:col-span-3 bg-white rounded-2xl border border-gray-100 p-4 sm:p-6 overflow-auto max-h-[60vh] lg:max-h-[70vh]' ref={resumeRef}>
                <div className='w-full flex justify-center'>
                    <div style={{ transform: `scale(${baseWidth > 0 ? Math.min(1, (baseWidth - 48) / 794) : 1})`, transformOrigin: 'top center' }}>
