export const landingPageStyles = {
  ...
  // Hero section
  heroSection: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8",
  heroGrid: "flex flex-wrap justify-between gap-10 lg:gap-12 items-center",
  heroLeft: "space-y-7",
  tagline: "inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-violet-100 to-fuchsia-100 border border-violet-200 text-violet-700 rounded-full font-semibold text-sm",
  heading: "text-5xl sm:text-6xl lg:text-7xl font-black leading-tight",
  ...
  description: "text-lg sm:text-xl text-slate-600 leading-relaxed max-w-lg font-medium",
  ctaButtons: "flex flex-col sm:flex-row gap-4 mt-8",

  // Buttons
  primaryButton: "group relative px-6 py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-semibold text-base rounded-lg overflow-hidden transition-all hover:scale-105 hover:shadow-lg hover:shadow-violet-200",
  ...
  secondaryButton: "px-6 py-3 border-2 border-violet-200 text-violet-700 font-semibold text-base rounded-lg hover:border-violet-300 hover:bg-violet-50 transition-all",
...
export const dashboardStyles = {
  ...
  // Header
  headerWrapper: "flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10",
  headerTitle: "text-3xl sm:text-4xl font-bold text-gray-900 mb-2",
  headerSubtitle: "text-base sm:text-lg text-gray-600",

  // Create Button
  createButton: "group relative px-8 py-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-xl overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-violet-200",
  ...
  // Empty State
  emptyStateWrapper: "flex flex-col items-center justify-center py-16 text-center",
  emptyIconWrapper: "bg-violet-100 p-6 rounded-full mb-6",
  emptyTitle: "text-2xl font-bold text-gray-900 mb-3",
  emptyText: "text-gray-600 max-w-md mb-8",

  // Grid
  grid: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8",

  // New Resume Card
  newResumeCard: "flex flex-col items-center justify-center bg-gradient-to-br from-violet-50 to-blue-50 border-2 border-dashed border-violet-300 rounded-2xl p-8 cursor-pointer transition-all hover:shadow-lg hover:border-violet-500 h-full min-h-[280px]",
  newResumeIcon: "w-16 h-16 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 flex items-center justify-center mb-6",
  newResumeTitle: "text-xl font-bold text-gray-900 mb-3 text-center",
  ...
  // Delete Confirmation
  deleteIconWrapper: "bg-red-100 p-4 rounded-full mb-6",
  deleteTitle: "text-lg font-bold text-gray-900 mb-3",
